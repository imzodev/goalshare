      ...
      <CardContent className="p-6">
        <figure className="h-full flex flex-col">
          ...
          <figcaption className="flex items-center gap-3 mt-auto">
            ...
            <div>
              <div className="font-semibold leading-none group-hover:text-primary transition-colors duration-300">{author}</div>
              {role ? <div className="text-muted-foreground text-sm mt-1">{role}</div> : null}
            </div>
          </figcaption>
        </figure>
      </CardContent>
